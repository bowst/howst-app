...
5. You are done! Visit `http://localhost:<port>` to see your newly-cloned site.
6. If you want to specify a URL to your local site, simply edit your /etc/hosts file.
