...
var getConfig = exports.getConfig = function(hostname){
  return [
    {
    ...
    },
    {
      ...
      prompt: "Full path to folder containing drush alias file(s)",
      default: userHome + "/.drush/" + hostname
    },
    {
      key: "drush_alias",
...
var configMachine = exports.configMachine = function(newMachine, howst, callback){
  ...
  var index = 0;
  var config = getConfig(newMachine.hostname);
